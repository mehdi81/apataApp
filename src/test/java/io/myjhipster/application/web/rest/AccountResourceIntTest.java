package io.myjhipster.application.web.rest;

import io.myjhipster.application.config.Constants;
import io.myjhipster.application.ApataApp;
import io.myjhipster.application.domain.Authority;
import io.myjhipster.application.domain.PersistentToken;
import io.myjhipster.application.domain.User;
import io.myjhipster.application.repository.AuthorityRepository;
import io.myjhipster.application.repository.PersistentTokenRepository;
import io.myjhipster.application.repository.UserRepository;
import io.myjhipster.application.security.AuthoritiesConstants;
import io.myjhipster.application.service.MailService;
import io.myjhipster.application.service.dto.UserDTO;
import io.myjhipster.application.web.rest.errors.ExceptionTranslator;
import io.myjhipster.application.web.rest.vm.KeyAndPasswordVM;
import io.myjhipster.application.web.rest.vm.ManagedUserVM;
import io.myjhipster.application.service.UserService;
...
@SpringBootTest(classes = ApataApp.class)
